...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="../Usuario/assets/img/favicon.ico">
            <link rel="stylesheet" href="../Usuario/assets/css/bootstrap.min.css">
            <link rel="stylesheet" href="../Usuario/assets/css/owl.carousel.min.css">
            <link rel="stylesheet" href="../Usuario/assets/css/flaticon.css">
            <link rel="stylesheet" href="../Usuario/assets/css/slicknav.css">
            <link rel="stylesheet" href="../Usuario/assets/css/animate.min.css">
            <link rel="stylesheet" href="../Usuario/assets/css/magnific-popup.css">
            <link rel="stylesheet" href="../Usuario/assets/css/fontawesome-all.min.css">
            <link rel="stylesheet" href="../Usuario/assets/css/themify-icons.css">
            <link rel="stylesheet" href="../Usuario/assets/css/slick.css">
            <link rel="stylesheet" href="../Usuario/assets/css/nice-select.css">
            <link rel="stylesheet" href="../Usuario/assets/css/style.css">
   </head>
                   ...
                   <div class="container-fluid">
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    <div class="flag">
                                        <img src="../Usuario/assets/img/icon/header_icon.png" alt="">
                                    </div>
                                    <div class="select-this">
                                        <form action="#">
                                            <div class="select-itms">
               ...
               <div class="header-bottom  header-sticky">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                  <a href="#"><img src="../Usuario/assets/img/logo/" alt=""></a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-8 col-md-7 col-sm-5">
                                <div class="main-menu f-right d-none d-lg-block">
